  ...
  if (!ready) {
    return (
      <EmptyState>
        ...
        />
        <EmptyStateBody>
          Enter both an <strong>agent</strong> and a <strong>tool</strong> in the filter bar
          above to see which principals triggered that delegation path.
        </EmptyStateBody>
      </EmptyState>
    );
  }
        ...
        <Tbody>
          {data.map((p, i) => (
            <Tr key={i}>
              ...
              <Td><span style={{ fontWeight: 600 }}>{p.count}</span></Td>
